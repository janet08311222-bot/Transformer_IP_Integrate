...
`ifdef VIVA
    ...
    `define IF_PAT 	"C:/Users/user/Desktop/yolo/512pe/pat/input_token.dat"	
    `define KER_PAT	"C:/Users/user/Desktop/yolo/512pe/pat/FFN_W1.dat"      //DMA_KER_TEST
    `define BIAS_PAT	"C:/Users/user/Desktop/yolo/512pe/pat/bias1.dat"
    //----gold pattern ----
    `define OF_GOLD	    "C:/Users/user/Desktop/yolo/512pe/pat/FFN1_out.dat"
`endif
...
always @(posedge clk ) begin
    if(reset)
        tb_o_cnt <= 0 ;
    else if( M_AXIS_S2MM_TREADY && M_AXIS_S2MM_TVALID )
        tb_o_cnt <= tb_o_cnt +1  ;
end
...
`ifdef FFN1
    always @(posedge clk) begin
        ...
        else if(M_AXIS_S2MM_TREADY && M_AXIS_S2MM_TVALID) begin
...
`endif
always @(posedge clk) begin
    if( M_AXIS_S2MM_TREADY && M_AXIS_S2MM_TVALID )
