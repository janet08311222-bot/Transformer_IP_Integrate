...
// Modify   : Added 2-Row Parallel Write Support Verification
// ============================================================================
`ifndef ASIC
...
localparam KER_ADDR_CNT_BITS	 =	12	 ;  
localparam STARTER_BITS			 =	8	 ;
localparam PADLEN_BITS			 =	8	 ;
localparam BUF_TAG_BITS 		 =	8	 ;
localparam PEBLKROW_NUM			 =	8	 ;	
localparam CNTSTP_WIDTH			 = 	3	 ; 	
localparam IFWSTG0_CNTBITS		 = 	8	 ;	
localparam IFWSTG1_CNTBITS		 = 	7	 ;
localparam DATAIN_CNT_BITS		 = 	16	 ;	
...
//========    I/O port declare    ========
	input wire clk	;
	input wire resetn	;
	output wire				rdwd_done			;	// SA layer finished -> Transformer_FSM

	// AXI-Stream now terminates in Transformer_top; only S2MM ready is still
	// needed by ot_top for output back-pressure.
	input  wire             M_AXIS_S2MM_TREADY	;

//-- input fifo signal (driven by Transformer_top) --
input wire [TBITS-1: 0 ]	isif_data_dout			;
input wire 					isif_last_dout			;
input wire 					isif_empty_n			;
input wire [TBYTE-1: 0 ]	isif_strb_dout			;
input wire 					isif_user_dout			;
...
output wire 				osif_last_din			;
//  osif_strb_din / osif_user_din: 常數接線 (8'hff / 1'b0),由 Transformer_top 綁定
wire [TBITS-1: 0 ]	endian_data_in			;
...
wire read_for_gi		;
wire gi_start ;
//  config_param00 (instr_code00) 沒人讀 -> get_ins 的 .instr_code00 已改空接
...
// ===== 2-row parallel wires =====
wire [TBITS-1:0] ifr_data_r1_0, ifr_data_r1_1, ifr_data_r1_2, ifr_data_r1_3, ifr_data_r1_4, ifr_data_r1_5, ifr_data_r1_6, ifr_data_r1_7 ;
wire ifr_valid_r1_0, ifr_valid_r1_1, ifr_valid_r1_2, ifr_valid_r1_3, ifr_valid_r1_4, ifr_valid_r1_5, ifr_valid_r1_6, ifr_valid_r1_7 ;
wire ifr_final_r1_0, ifr_final_r1_1, ifr_final_r1_2, ifr_final_r1_3, ifr_final_r1_4, ifr_final_r1_5, ifr_final_r1_6, ifr_final_r1_7 ;
wire [PEBLKROW_NUM*TBITS-1:0] pe2o_allq_dout_r1;
wire [PEBLKROW_NUM-1:0]       pe2o_allvalid_dout_r1;
wire pe_valid_r1_0, pe_valid_r1_1, pe_valid_r1_2, pe_valid_r1_3, pe_valid_r1_4, pe_valid_r1_5, pe_valid_r1_6, pe_valid_r1_7 ;
wire pe_final_r1_0, pe_final_r1_1, pe_final_r1_2, pe_final_r1_3, pe_final_r1_4, pe_final_r1_5, pe_final_r1_6, pe_final_r1_7 ;
...
//----    kernel read cfg    -----
wire	[BUF_TAG_BITS-1:0]  	cfg_kernum_sub1		;	
wire	[KER_ADDR_CNT_BITS-1:0]		cfg_colout_sub1		;	
wire	[KER_ADDR_CNT_BITS-1:0]		cfg_normal_length	;	
wire	[STARTER_BITS*5	-1:0]	cfgin_top_starter		;
wire	[PADLEN_BITS*5	-1:0]	cfgin_toppad_length		;	
wire	[PADLEN_BITS*5	-1:0]	cfgin_botpad_length		;	
//----    kernel write cfg    -----
wire	[KER_ADDR_CNT_BITS-1:0 ]	cfg_kerw_buflength ;
//----    bias r_w cfg    -----
...
// ===========================================================================
	...
	ifsram_rw #(    
		...
		// ===== 2-row parallel: r1 ifmap output ports =====
		,	.dout_ifsr_r1_0 ( ifr_data_r1_0 ), .ifr_valid_r1_0 ( ifr_valid_r1_0 ), .ifr_final_r1_0 ( ifr_final_r1_0 )
		,	.dout_ifsr_r1_1 ( ifr_data_r1_1 ), .ifr_valid_r1_1 ( ifr_valid_r1_1 ), .ifr_final_r1_1 ( ifr_final_r1_1 )
		,	.dout_ifsr_r1_2 ( ifr_data_r1_2 ), .ifr_valid_r1_2 ( ifr_valid_r1_2 ), .ifr_final_r1_2 ( ifr_final_r1_2 )
		,	.dout_ifsr_r1_3 ( ifr_data_r1_3 ), .ifr_valid_r1_3 ( ifr_valid_r1_3 ), .ifr_final_r1_3 ( ifr_final_r1_3 )
		,	.dout_ifsr_r1_4 ( ifr_data_r1_4 ), .ifr_valid_r1_4 ( ifr_valid_r1_4 ), .ifr_final_r1_4 ( ifr_final_r1_4 )
		,	.dout_ifsr_r1_5 ( ifr_data_r1_5 ), .ifr_valid_r1_5 ( ifr_valid_r1_5 ), .ifr_final_r1_5 ( ifr_final_r1_5 )
		,	.dout_ifsr_r1_6 ( ifr_data_r1_6 ), .ifr_valid_r1_6 ( ifr_valid_r1_6 ), .ifr_final_r1_6 ( ifr_final_r1_6 )
		,	.dout_ifsr_r1_7 ( ifr_data_r1_7 ), .ifr_valid_r1_7 ( ifr_valid_r1_7 ), .ifr_final_r1_7 ( ifr_final_r1_7 )
	...
	ker_top  #(    
		...
		,	.dout_kersr_0 ( ksr_data_0 ), .ksr_valid_0  ( ksr_valid_0 ), .ksr_final_0  ( ksr_final_0 ) 
		,	.dout_kersr_1 ( ksr_data_1 ), .ksr_valid_1  ( ksr_valid_1 ), .ksr_final_1  ( ksr_final_1 ) 
		,	.dout_kersr_2 ( ksr_data_2 ), .ksr_valid_2  ( ksr_valid_2 ), .ksr_final_2  ( ksr_final_2 ) 
		,	.dout_kersr_3 ( ksr_data_3 ), .ksr_valid_3  ( ksr_valid_3 ), .ksr_final_3  ( ksr_final_3 ) 
		,	.dout_kersr_4 ( ksr_data_4 ), .ksr_valid_4  ( ksr_valid_4 ), .ksr_final_4  ( ksr_final_4 ) 
		,	.dout_kersr_5 ( ksr_data_5 ), .ksr_valid_5  ( ksr_valid_5 ), .ksr_final_5  ( ksr_final_5 ) 
		,	.dout_kersr_6 ( ksr_data_6 ), .ksr_valid_6  ( ksr_valid_6 ), .ksr_final_6  ( ksr_final_6 ) 
		,	.dout_kersr_7 ( ksr_data_7 ), .ksr_valid_7  ( ksr_valid_7 ), .ksr_final_7  ( ksr_final_7 ) 
	...
	//----    AXI-Stream fifos live in Transformer_top now    -----
	// INPUT_STREAM_if		#(
	// 		.TBITS	(	TBITS	)
	// 	,	.TBYTE	(	TBYTE	)
	// )axififo_in (
	...
	ot_top 	#(
		...
		,   .valid_din_r1  		( pe2o_allvalid_dout_r1 )   // �걵 Row 1 �H��
        ,   .data_din_r1   		( pe2o_allq_dout_r1     )   
...
// ===== 2-row parallel: r1 pe_valid / pe_final =====
	assign pe_valid_r1_0 = (ksr_valid_0 & ifr_valid_r1_0) ;
	assign pe_valid_r1_1 = (ksr_valid_1 & ifr_valid_r1_1) ;
	assign pe_valid_r1_2 = (ksr_valid_2 & ifr_valid_r1_2) ;
	assign pe_valid_r1_3 = (ksr_valid_3 & ifr_valid_r1_3) ;
	assign pe_valid_r1_4 = (ksr_valid_4 & ifr_valid_r1_4) ;
	assign pe_valid_r1_5 = (ksr_valid_5 & ifr_valid_r1_5) ;
	assign pe_valid_r1_6 = (ksr_valid_6 & ifr_valid_r1_6) ;
	assign pe_valid_r1_7 = (ksr_valid_7 & ifr_valid_r1_7) ;
	assign pe_final_r1_0 = (ksr_final_0 & ifr_final_r1_0) ;
	assign pe_final_r1_1 = (ksr_final_1 & ifr_final_r1_1) ;
	assign pe_final_r1_2 = (ksr_final_2 & ifr_final_r1_2) ;
	assign pe_final_r1_3 = (ksr_final_3 & ifr_final_r1_3) ;
	assign pe_final_r1_4 = (ksr_final_4 & ifr_final_r1_4) ;
	assign pe_final_r1_5 = (ksr_final_5 & ifr_final_r1_5) ;
	assign pe_final_r1_6 = (ksr_final_6 & ifr_final_r1_6) ;
	assign pe_final_r1_7 = (ksr_final_7 & ifr_final_r1_7) ;

// ===== 2-row parallel: second pe_top instance =====
	pe_top	#(
			.TBITS 				(	TBITS	)
		,	.TBYTE 			(	TBYTE	)
		,	.PEBLKROW_NUM	(	PEBLKROW_NUM	)
		...
		,	.flat_ker_din	(	{ksr_data_0 , ksr_data_1 , ksr_data_2 , ksr_data_3 , ksr_data_4 , ksr_data_5 , ksr_data_6 , ksr_data_7} )
		,	.flat_bias_din	(	{bias_sel_ot_0 , bias_sel_ot_1 , bias_sel_ot_2 , bias_sel_ot_3 , bias_sel_ot_4 , bias_sel_ot_5 , bias_sel_ot_6 , bias_sel_ot_7}	)
		,	.flat_valid_din	(	{pe_valid_r1_0, pe_valid_r1_1, pe_valid_r1_2, pe_valid_r1_3, pe_valid_r1_4, pe_valid_r1_5, pe_valid_r1_6, pe_valid_r1_7})
		,	.flat_final_din	(	{pe_final_r1_0, pe_final_r1_1, pe_final_r1_2, pe_final_r1_3, pe_final_r1_4, pe_final_r1_5, pe_final_r1_6, pe_final_r1_7})
		,	.flat_act_din	(	{ifr_data_r1_0, ifr_data_r1_1, ifr_data_r1_2, ifr_data_r1_3, ifr_data_r1_4, ifr_data_r1_5, ifr_data_r1_6, ifr_data_r1_7})
		,	.allq_dout		(	pe2o_allq_dout_r1		)
		,	.allvalid_dout	(	pe2o_allvalid_dout_r1	)
	);
...
assign cfg_m0_scale		=	config_param01[63 -: 32];
...
assign cfg_total_row    =	config_param02[63 -: 9];		
assign cfg_base_number  = 	config_param02[(47-2) -: 6];
assign cfg_atlchin 		= 	config_param03[(63):56]; 	
assign cfg_conv_switch 	= 	config_param03[(55-5):48];
assign cfg_mast_state 	= 	config_param03[(47-5):40];
assign cfg_pd_list_0 	= 	config_param03[(39-3):24];
assign cfg_pd_list_1 	= 	config_param03[(23-3):8];
assign cfg_pd_list_2 	= 	config_param04[(63-3):48];
assign cfg_pd_list_3 	= 	config_param04[(47-3):32];	
...
//  cfg_pdlf / cfg_pdrg / cfg_nor (config_param05 的 byte 0/1/2) 全設計沒人讀,已移除
assign cfg_stg0_nor_finum 	= config_param05[(63-8*4 + IFWSTG0_CNTBITS)	-:	IFWSTG0_CNTBITS	];
assign cfg_stg0_pdb0_finum 	= config_param05[(63-8*5 + IFWSTG0_CNTBITS)	-:	IFWSTG0_CNTBITS	];	
assign cfg_stg0_pdb1_finum 	= config_param05[(63-8*6 + IFWSTG0_CNTBITS)	-:	IFWSTG0_CNTBITS	];
assign cfg_stg1_eb_col 		= config_param05[(63-8*7 + IFWSTG1_CNTBITS)	-:	IFWSTG1_CNTBITS	];	
assign cfg_dincnt_finum 	= config_param06[(63-16+DATAIN_CNT_BITS) -: DATAIN_CNT_BITS];	
assign cfg_rowcnt_finum 	= config_param06[(63-16) -: 8];
assign cfg_ifr_window 		= config_param07[63 -:	8];	
assign cfg_ift_total_window = config_param07[55 -: 8];
...
assign cfg_ot_tgpfnsub1		= config_param14[(63 - OTSRAM_ADDR_BITS )   -:  OTSRAM_ADDR_BITS ]	;
assign cfg_ot_tcolfnsub1	= config_param14[(63 - OTSRAM_ADDR_BITS*2 ) -:  OTSRAM_ADDR_BITS ]	;		
assign cfg_ot_tchafnsub1	= config_param15[(63  ) 					-:  OTSRAM_ADDR_BITS ]	;
assign cfg_ot_sft_gp		= config_param15[(63 - OTSRAM_ADDR_BITS )   -:  OTSRAM_ADDR_BITS ]	;
assign cfg_ot_sft_colpra	= config_param15[(63 - OTSRAM_ADDR_BITS*2 ) -:  OTSRAM_ADDR_BITS ]	;		
endmodule