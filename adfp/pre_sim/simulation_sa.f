# simulation.f -- Transformer_top RTL pre-sim, Self-Attention  (school box)
# In pre_sim/:   source simulation_sa.f
#
...
-sverilog +v2k \
-l sim_log/presim_sa.log \
+incdir+../src \
-y ${SYNOPSYS}/dw/sim_ver +libext+.v \
-f vcode.f \
../tb/new_tb_512MAC.sv -top fsm_check_tb \
